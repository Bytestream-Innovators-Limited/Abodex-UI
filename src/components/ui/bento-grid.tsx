  ...
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        <Icon className="h-12 w-12 origin-left transform-gpu text-border transition-all duration-300 ease-in-out group-hover:scale-75" />
        <h3 className="text-md lg:text-xl font-semibold text-neutral-700 dark:text-neutral-300">
          {name}
        </h3>
