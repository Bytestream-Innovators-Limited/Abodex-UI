...
export const RentExpired = ({
	tenantName,
	propertyName,
	expirationDate,
	renewLink,
}: RentExpiredProps) => {
	const previewText = `Your rent for ${propertyName} has expired`
				...
				<Body className="bg-white my-auto mx-auto font-sans px-2">
					<Container className="border border-solid border-[#eaeaea] rounded my-10 mx-auto p-5 max-w-[465px]">
						...
						<Text className="text-black text-[14px] leading-6">
							...
							expired on {expirationDate}. Your tenancy is no
							longer active.
						</Text>
						<Text className="text-black text-[14px] leading-6">
							Renew your rent to continue your tenancy at{" "}
							{propertyName}.
						</Text>
						...
						<Text className="text-[#666666] text-[12px] leading-6">
							To continue your tenancy, please renew your rent as
							soon as possible. Contact our team if you have
							questions about your rental status.
						</Text>
						<Text className="text-[#666666] text-[12px] leading-6">
...
export const RentExpiredHTML = async ({
	tenantName,
	propertyName,
	expirationDate,
	renewLink,
